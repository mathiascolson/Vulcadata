...
MODEL_TYPE = "CNN_BiLSTM_Classifier"
DEFAULT_OUTPUT_DIR = "models/cnn_bilstm_classifier"
DEFAULT_RUN_NAME = "cnn_bilstm_volcano_multiclass"
...
def add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--early-stopping-metric", type=str, default="macro_f1")
    ...
    parser.add_argument(
        ...
        type=str,
        default="balanced",
        choices=["none", "balanced", "alert_priority"],
...
if __name__ == "__main__":
    ...
    parser.set_defaults(
        best_model_name="best_cnn_bilstm_classifier.pt",
        history_name="history_cnn_bilstm_classifier.json",
        metrics_name="metrics_cnn_bilstm_classifier.json",
        predictions_name="predictions_cnn_bilstm_classifier.npz",
        confusion_name="confusion_matrix_cnn_bilstm_classifier.npy",
    )
