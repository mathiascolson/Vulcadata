...
DEFAULT_OUTPUT_DIR = "models/transformer_classifier"
DEFAULT_RUN_NAME = "transformer_volcano_multiclass"
...
if __name__ == "__main__":
    ...
    parser.set_defaults(
        best_model_name="best_transformer_classifier.pt",
        history_name="history_transformer_classifier.json",
        metrics_name="metrics_transformer_classifier.json",
        predictions_name="predictions_transformer_classifier.npz",
        confusion_name="confusion_matrix_transformer_classifier.npy",
    )
