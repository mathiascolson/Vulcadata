...
CNN_TRANSFORMER_MODEL_PROFILES = [
    {
        "profile_name": "cnn_transformer_regularized_base",
        "d_model": 128,
        "nhead": 4,
        "num_layers": 4,
        "dim_feedforward": 256,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--transformer-script",
        type=str,
        default="scripts/train_transformer.py",
    )

    parser.add_argument(
        "--cnn-transformer-script",
        type=str,
        default="scripts/train_cnn_transformer_regression.py",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Patience commune. Plus élevée pour laisser les modèles se rattraper.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.001,
        help="Min delta utilisé par le CNN-Transformer.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Patience du scheduler ReduceLROnPlateau pour train_transformer.py.",
    )
