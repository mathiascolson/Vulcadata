...
def main(args):
    ...
    print("\nPlan de sweep CNN-BiLSTM classification")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Nom court du dataset. Exemple : with_quiet_stride5.",
    )

    parser.add_argument(
        "--output-root",
        type=str,
        default="models/sweeps_cnn_bilstm_classification",
    ...
    parser.add_argument(
        "--train-script",
        type=str,
        default="scripts/train_cnn_bilstm_classif.py",
